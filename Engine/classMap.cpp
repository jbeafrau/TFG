...
void classMap::generateTiles(int currentState)
{
    ...
    case my_enums::S_NECRO_WORLD_: 
        ...
        //maps to final boss
        road({ 49,49,150,2 }, 20, 27);
        road({ 199,49,2,150 }, 20, 27);
        road({ 99,197,100,2 }, 20, 27);
        road({ 99,107,2,92 }, 20, 27);
        road({ 99,107,50,2 }, 20, 27);
        road({ 149,107,2,50 }, 20, 27);
        road({ 131,157,20,2 }, 20, 27);
        //bridge
        map_cells[128][158] = 20;
        map_cells[129][158] = 20;
