...
bool game::loadMedia(string base)
{
    ...
    string MUSIC = sounds + "music8bit.wav";
    music8bit = Mix_LoadMUS( MUSIC.c_str() );
 MUSIC = sounds + "musicretro.wav";
    musicRetro = Mix_LoadMUS( MUSIC.c_str() );
 MUSIC = sounds + "musicfunky.wav";
    musicFunky = Mix_LoadMUS( MUSIC.c_str() );

    MUSIC = sounds + "TD_Game_Over_Slow_Loop.wav";
 musicGameOver  = Mix_LoadMUS(MUSIC.c_str());

     string Audio6 = sounds + "Button7.mp3";
   ...
   line = Mix_LoadWAV( Audio6.c_str());
    ...
    Audio6 = sounds + "TD_Win_Stinger_01_02.wav";
